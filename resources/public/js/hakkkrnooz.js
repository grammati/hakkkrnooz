...
(function() {
  var K, Kmap, KmapVim, addColumn, appendComments, columnWidth, commentCache, commentHtml, commentTemplate, focusNext, focusPrev, getParent, htmlFor, initEvents, jobAdHtml, openCurrent, positionItem, removeLastColumn, scrollH, showChildren, showComments, showReplies, showStories, storyHtml, storyTemplate, upToParent;
  ...
  initEvents = function() {
    return $(document).on('keydown', 'div.item', function(evt) {
      ...
      return positionItem(evt.target);
    });
  };
