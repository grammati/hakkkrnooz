...
(function() {
  ...
  focusNext = function(elt) {
    var ref;
    return (ref = elt.next()) != null ? ref.focus() : void 0;
  };

  focusPrev = function(elt) {
    var ref;
    return (ref = elt.prev()) != null ? ref.focus() : void 0;
  };
  ...
  positionItem = function(elt) {
    var column, e, isFirst, pos, targetTop;
    elt = $(elt);
    pos = elt.position();
    column = $(elt.parent());
  ...
  openCurrent = function(item) {
    switch (item != null ? item.data('type') : void 0) {
      case 'story':
  ...
  addColumn = function() {
    ...
    newCol = $('<div/>').addClass('column').css('left', ncols * columnWidth).data('column-number', 1 + ncols);
  ...
  showComments = function(story) {
    var div, id;
    id = story != null ? story.prop('id') : void 0;
    if (!/^\d+$/.exec(id)) {
      return;
    }
    if (loading === id) {
